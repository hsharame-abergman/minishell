...
/*   Updated: 2024/11/11 15:28:01 by abergman         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
	Восстанавливает исходный стандартный вход и выход до исходных значений 0 и 1. Используется для удаления входных/выходных значений после выполнения в качестве подготовки к следующему набору команд пользователя.
